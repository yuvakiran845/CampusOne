...
const Header = ({ toggleSidebar, isSidebarOpen }) => {
    ...
    return (
        <header className="sticky top-0 z-40 h-16 md:h-20 bg-white/95 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-5 md:px-8">
            {/* Left Section - Empty as Logo is in Sidebar */}
            ...
            {/* Right Section: Notifications, Profile & Burger */}
            <div className="flex items-center gap-3 md:gap-4">
                ...
                <button
                    ...
                    className="p-2.5 rounded-xl text-slate-900 lg:hidden bg-slate-100/50 hover:bg-slate-100 transition-all min-h-[44px] min-w-[44px]"
                >
